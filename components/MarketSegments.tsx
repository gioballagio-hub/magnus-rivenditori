    ...
    return (
        <section className="py-20 sm:py-24 lg:py-32 bg-[#1A1A1A] section-dots">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="fade-up mt-20 bg-[#111111] border-2 border-dashed border-[#CC0000] p-8 rounded-lg text-center" style={{ transitionDelay: '500ms'}}>
                    <h3 className="font-heading font-bold text-2xl sm:text-3xl text-white">
                        <span role="img" aria-label="oil-drum" className="mr-2">🛢️</span> AMSOIL — IMPORTATORE UFFICIALE PER L'ITALIA
                    </h3>
                    <p className="mt-4 max-w-3xl mx-auto text-lg text-[#8A8A8A]">
                        Lubrificanti sintetici premium per ogni applicazione: <br/> Automotive American | European | V-Twin | Dirt Bike
                    </p>
                </div>
            </div>
        </section>
